            ...
            <ul className="list-none sidebar-nav mb-0 mt-3" id="navmenu-nav">
              ...
              <li className="navbar-item account-menu">
                <Link
                  ...
                  className={`${pathname === "/profile-billing" ? "text-indigo-600 dark:text-white" : "text-slate-400"} navbar-link  flex items-center py-2 rounded hover:text-indigo-600`}
                >
                  <span className="me-2 text-[18px] mb-0">
                    <TbNotebook />
                  </span>
              ...
              <li className="navbar-item account-menu">
                <Link
                  ...
                  className={`${pathname === "/profile-payment" ? "text-indigo-600 dark:text-white" : "text-slate-400"} navbar-link  flex items-center py-2 rounded hover:text-indigo-600`}
                >
                  <span className="me-2 text-[18px] mb-0">
                    <AiOutlineCreditCard />
                  </span>
              ...
              <li className="navbar-item account-menu">
                <Link
                  href="/profile-social"
                  className={`${pathname === "/profile-social" ? "text-indigo-600 dark:text-white" : "text-slate-400"} navbar-link  flex items-center py-2 rounded hover:text-indigo-600`}
                >
                  <span className="me-2 text-[18px] mb-0">
                    <FaRecycle />
                  </span>
              ...
              <li className="navbar-item account-menu">
                <Link
                  ...
                  className={`${pathname === "/profile-notification" ? "text-indigo-600 dark:text-white" : "text-slate-400"} navbar-link  flex items-center py-2 rounded hover:text-indigo-600`}
                >
                  <span className="me-2 text-[18px] mb-0">
                    <LuBellRing />
                  </span>
              ...
              <li className="navbar-item account-menu">
                <Link
                  ...
                  className={`${pathname === "/profile-setting" ? "text-indigo-600 dark:text-white" : "text-slate-400"} navbar-link  flex items-center py-2 rounded hover:text-indigo-600`}
                >
                  <span className="me-2 text-[18px] mb-0">
                    <BiCog />
                  </span>
              ...
              <li className="navbar-item account-menu">
                <Link
                  ...
                  className={`${pathname === "/auth-lock-screen" ? "text-indigo-600 dark:text-white" : "text-slate-400"} navbar-link  flex items-center py-2 rounded hover:text-indigo-600`}
                >
                  <span className="me-2 text-[18px] mb-0">
                    <CgLogOff />
                  </span>
